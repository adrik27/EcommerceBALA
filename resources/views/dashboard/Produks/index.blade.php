                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="customer_name">Kode</th>
                                    <th class="sort" data-sort="email">Nama</th>
                                    <th class="sort" data-sort="phone">Harga</th>
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="date">{{ $pr->kode }}</td>
                                    <td class="date">{{ $pr->nama }}</td>
                                    <td class="date">{{ $pr->harga }}</td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="/dashboard/produks/{{ $pr->id }}"
                                                class="btn btn-sm btn-info show-item-btn">Detail</a>
                                            <a href="/dashboard/produks/{{ $pr->id }}/edit"
