...
<div class="row justify-content-center my-4">
    <div class="col-lg-8 shadow-lg p-5 rounded-3">
        ...
        <div class="col-lg">
            ...
            <form action="/dashboard/produks/{{ $produk->id }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" id="kode"
                        placeholder="Kode" value="{{ old('kode', $produk->kode) }}" autocomplete="off" required>
                    @error('kode')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama"
                        placeholder="Nama Produk" value="{{ old('nama', $produk->nama) }}" autocomplete="off" required>
                    @error('nama')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="harga" class="form-control @error('harga') is-invalid @enderror" id="harga"
                        placeholder="Harga Produk" value="{{ old('harga', $produk->harga) }}" autocomplete="off"
                        required>
                    @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input id="keterangan" class="@error('keterangan') is-invalid @enderror" type="hidden"
                        name="keterangan" value="{{ old('keterangan', $produk->keterangan) }}" autocomplete="off"
                        required>
                ...
                <button type="submit" class="btn btn-sm btn-success"
                    onclick="return confirm('Yakin ingin mengupdate produk ?')">Update Produk</button>
