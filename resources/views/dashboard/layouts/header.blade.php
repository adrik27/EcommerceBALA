                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            @else
                            <img class="rounded-3 header-profile-user" src="/image/avatardefault.png"
                                alt="Header Avatar">
                            @endif
                            <span class="text-center ms-xl-2">
                                <span class="d-none d-xl-inline-block  fw-bold user-name-text">{{
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="/dashboard/users/{{ auth()->user()->id }}"><i
